...
document.addEventListener('click', event => {
    ...
    .fromTo(DOMlayers, {
        ...
        duration: animationSettings.duration + animationSettings.delayFactor*(items.length-1) ,
        ease: 'linear',
        scale: 1.1
    }, 0)
    ...
    .addLabel('reveal', animationSettings.duration + animationSettings.delayFactor*(items.length-1))
    .add(() => toggleContent(), 'reveal')
    .to(lastItem, { // Animation for the last item
        duration: 1,
        ease: 'power3', // Different easing effect
        'clip-path': 'polygon(0% 0%, 0% 0%, 0% 100%, 0% 100%)', // Animating clip-path to different shape
